    ...
    return (
      <>
        <div className='my-order-container  flex flex-col'>
            <div className=''>
                <p className='text-center font font-semibold mt-6 w-full font text-lg underline'>My Order</p>
            </div>
            ...
            <p className='bg-green-500 font-semibold text-white text-lg rounded-lg h-8 pl-2 pr-2 mr-16'>{`Price: $${sumProductCart(previousOrder)}`}</p>
            </div>
        </div>
      </>
    )
